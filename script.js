...
// BASE DE DATOS JSON ACTUALIZADA
let lugaresPuntos = [
  {
  ...
  {
    "etiqueta": "SUR DE QUITO",
    "nombre": "Parque Lineal Car顺 (Río Machángara Sur)",
    "lat": -0.2720,
    "lng": -78.5312,
    "categoria": "GRATIS",
    "zona": "SUR",
...
function iniciarEstaticaTerminal() {
  const lineas = [
    "> INITIALIZING CYBER_QUITO_NET v9.0...",
    "[OK] Cargando nodos geográficos de Quito y Sur...",
    "[OK] Sistema listo."
  ];
...
function seleccionarLugar(lugar, marker) {
  ...
  const contenidoIW = `
    <div style="color:#ffffff;">
      <div style="font-weight:bold; color:#e2b041; font-size:15px; margin-bottom:4px;">
        ${lugar.sticker} ${lugar.nombre}
      </div>
      <div style="color:#a50044; font-weight:bold; font-size:12px; margin-bottom:8px;">
        PRECIO: ${lugar.categoria} | ZONA: ${lugar.zona}
      </div>
      <p style="margin-bottom:8px;">${lugar.descripcion}</p>
      <div style="font-size:12px; color:#e2b041; margin-bottom:6px;"><strong>Actividades:</strong></div>
      ${actividadesHTML}
      <div style="font-size:12px; color:#ffffff; margin-top:8px; background-color:#15294a; padding:6px; border-radius:4px;">
